      ...
      children: [
        ...
        { path: '/404', element: <NotFound /> },
        {
          ...
          children: [
            ...
            { path: '/shared/:ownerUsername/:collectionName', element: <ProtectedRoute><ViewCollection /></ProtectedRoute> },
            { path: '/shared/:ownerUsername/:collectionName/add-item', element: <ProtectedRoute><UpsertItem /></ProtectedRoute> },
            { path: '/shared/:ownerUsername/:collectionName/items/:itemId/edit', element: <ProtectedRoute><UpsertItem /></ProtectedRoute> },
